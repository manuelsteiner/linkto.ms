...
const ThemeToggle = () => {
  ...
  return (
    <>
      ...
      {
        theme !== undefined &&
        <button className={`${theme === 'light' ? 'text-white bg-purple-500 hover:bg-purple-600' : 'text-black bg-yellow-400 hover:bg-yellow-500'} font-bold rounded p-2 overflow-hidden`} onClick={changeTheme}>
