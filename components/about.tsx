...
const About = () => {
  ...
  return (
    <motion.section id="about" className="mt-4" initial={{ y: -10, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: .1 }}>
          ...
          qualifications.map(qualification => {
            return (
              <li key={qualification.time} className="mt-2 sm:mt-0">
                <span className="font-bold sm:mr-2">{qualification.time}:</span>
