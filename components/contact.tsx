...
const Contact = () => {
  ...
  return (
    <motion.section id="contact" className="mt-4" initial={{ y: -10, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: .1 }}>
      ...
      <p className="text-gray-900 dark:text-gray-50 leading-relaxed tracking-wide mt-2">
          ...
          contacts.map(contact => {
            return (
              <li key={contact.logo.name}>
                <contact.logo className="inline mr-2 text-gray-600 dark:text-gray-300" />
